...
public:
    ...
    void prepareData()
    {
        ...
        this->send_r2 = (-0.5 * this->r2) + 0.5;
        this->send_l2 = (this->l2 - 1.0) * 0.5;
    ...
    void publishTwistMsg() {
        ...
        {
            // Set linear vel
            if ((this->send_r2 >= 0.1) && (this->send_r2 <= maxVel))
            {
                msg.linear.x = this->send_r2;
            } else if ((this->send_l2 <= 0.0) && (this->send_l2 >= maxVelR))
            {
